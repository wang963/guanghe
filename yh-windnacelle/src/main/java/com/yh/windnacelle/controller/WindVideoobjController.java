 ...
 */
@RestController
@RequestMapping("/fanmonitor/videoobj")
public class WindVideoobjController extends BaseController
{
     ...
     * 查询视频检测列表
     */
    @PreAuthorize("@ss.hasPermi('fanmonitor:videoobj:list')")
    @GetMapping("/list")
     ...
     * 导出视频检测列表
     */
    @PreAuthorize("@ss.hasPermi('fanmonitor:videoobj:export')")
     ...
     * 获取视频检测详细信息
     */
    @PreAuthorize("@ss.hasPermi('fanmonitor:videoobj:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增视频检测
     */
    @PreAuthorize("@ss.hasPermi('fanmonitor:videoobj:add')")
     ...
     * 修改视频检测
     */
    @PreAuthorize("@ss.hasPermi('fanmonitor:videoobj:edit')")
     ...
     * 删除视频检测
     */
    @PreAuthorize("@ss.hasPermi('fanmonitor:videoobj:remove')")
